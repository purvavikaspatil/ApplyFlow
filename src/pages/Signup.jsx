  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4">
      <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-lg">
        ...
        <p className="mb-6 text-sm text-slate-600">Start tracking your applications with ApplyFlow</p>
        ...
        <p className="mt-4 text-sm text-slate-600">
          ...
          <Link to="/login" className="font-medium text-blue-700 underline hover:text-blue-800">
            Sign in
          </Link>
        </p>
      </div>
